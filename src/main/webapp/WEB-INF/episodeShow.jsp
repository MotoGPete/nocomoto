...
<link rel="stylesheet" type="text/css"
	href="/nocomoto/src/main/resources/static/css/episode.css">
...
<body class="container body">
	...
	<div class="container text-center mt-5">
		...
		<h2>Episode ${episode.episode_number} ${formattedEpisodeDate}</h2>
		<h3>${episode.title}</h3>
		...
		<div class="row">
			<div class="col-md-8">
				<div class="page-header">
					<h1>
						<small class="pull-right">${episode.comments.size()} Comments</small> 
					</h1>
				</div>
